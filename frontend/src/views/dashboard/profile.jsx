...
//     mobile: user?.mobile || "+91-9973152523",
//     role: user?.role || "Pharmacy",
//     location: user?.location || "Gachibowli, Hyderabad, Telangana, 500032",
//     languages: user?.languages || "English, Hindi, Bhojpuri",
//   });
...
//             </TabsList>
//             <TabsContent value="editProfile" className="w-full">
//               <EditProfile setProfileData={setProfileData} />
//             </TabsContent>
//             <TabsContent value="changePassword">
//               <div className="w-full my-3">
//                 <div className="w-full my-2 relative">
...
//                   />
//                   {newPasswordShow ? (
//                     <FaRegEyeSlash className="absolute right-[10px] bottom-[10px] cursor-pointer hover:text-blue-800 hover:scale-110 duration-300 transition-all text-xl text-gray-800" onClick={() => setNewPasswordShow(!newPasswordShow)} />
//                   ) : (
//                     <FaRegEye className="absolute right-[10px] bottom-[10px] cursor-pointer hover:text-blue-800 hover:scale-110 duration-300 transition-all text-xl text-gray-800" onClick={() => setNewPasswordShow(!newPasswordShow)} />
//                   )}
//                 </div>
//                 <div className="w-full my-2 relative">
...
//                   />
//                   {confirmPasswordShow ? (
//                     <FaRegEyeSlash className="absolute right-[10px] bottom-[10px] cursor-pointer hover:text-blue-800 hover:scale-110 duration-300 transition-all text-xl text-gray-800" onClick={() => setConfirmPasswordShow(!confirmPasswordShow)} />
//                   ) : (
//                     <FaRegEye className="absolute right-[10px] bottom-[10px] cursor-pointer hover:text-blue-800 hover:scale-110 duration-300 transition-all text-xl text-gray-800" onClick={() => setConfirmPasswordShow(!confirmPasswordShow)} />
//                   )}
//                 </div>
//               </div>
//             </TabsContent>
